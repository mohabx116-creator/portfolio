...
function Footer() {
  ...
  return (
    <footer className="bg-surface px-4 py-10 sm:px-6 lg:px-8">
      <Container>
        <div className="grid gap-8 border-t border-outline-variant/15 pt-8 sm:gap-10 md:grid-cols-3">
          ...
          <div className="text-start">
            ...
            <div className="mt-3 grid gap-2 text-sm text-on-muted break-all sm:break-normal">
