        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 xl:gap-16">
          <Reveal className="text-start">
            ...
            <div className={`mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4 ${buttonAlign}`}>
              <ButtonLink href="#contact" className="soft-glow w-full px-6 py-4 text-base sm:w-auto sm:min-w-[240px] sm:px-10 sm:text-lg lg:min-w-[260px] lg:px-12 lg:py-5 lg:text-xl">
                {hero.primaryCta}
              </ButtonLink>
              <ButtonLink
                href="#projects"
                variant="ghost"
                className="w-full border border-outline-variant/15 bg-surface-card px-6 py-4 text-base shadow-[0_12px_30px_rgba(0,0,0,0.08)] hover:border-primary/25 hover:bg-surface-high sm:w-auto sm:min-w-[220px] sm:px-8 sm:text-lg lg:min-w-[250px] lg:px-10 lg:py-5 lg:text-xl"
              >
                {hero.secondaryCta}
              </ButtonLink>
            </div>
