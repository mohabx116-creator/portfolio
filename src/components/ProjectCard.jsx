    ...
    >
      ...
      <div className="p-6 text-start">
        <div className="mb-4 flex flex-wrap gap-2">
          <span className="rounded-md bg-primary/10 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-primary">{category}</span>
          <span className="rounded-md bg-secondary/10 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-secondary">{stack}</span>
        </div>
        <h3 className="font-headline text-[1.38rem] font-bold leading-8 text-on-surface transition-colors duration-300 group-hover:text-primary">{title}</h3>
